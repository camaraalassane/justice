<template>
    <GuestLayout title="Réinitialisation" subtitle="Définissez votre nouveau mot de passe">
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gpj-700 mb-1">Nouveau mot de passe</label>
                <div class="relative">
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-gpj-700 mb-1">Confirmer</label>
                <div class="relative">
                    <i class="pi pi-lock absolute left-3 top-1/2 -translate-y-1/2 text-gpj-400"></i>
                    <input
