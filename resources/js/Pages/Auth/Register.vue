<template>
    <GuestLayout title="Inscription" subtitle="Créez votre compte GPJ">
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <p class="text-center text-sm text-slate-500">
                Déjà un compte ?
                <Link :href="route('login')" class="text-slate-600 hover:text-slate-800 font-medium">Se connecter</Link>
            </p>
        </form>
    </GuestLayout>
</template>
